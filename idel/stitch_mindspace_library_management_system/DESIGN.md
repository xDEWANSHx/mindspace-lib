...
- **Glassmorphism:** Reserved for top navigation elements. Use a high-blur (20px) backdrop filter with 40% opacity Alabaster to simulate a frosted glass window.
...
### Navigation
The header is a fixed, minimalist bar.
