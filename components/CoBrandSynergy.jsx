...
import { Armchair, Wifi, Moon, Zap, Coffee, Sparkles } from "lucide-react";
...
const CARDS = [
  ...
  },
  {
    badge: "At Your Desk",
    badgeDot: "#D4B28C",
    title: "Noiric Café QR",
    body: "Scan the QR on your cabin desk. Artisanal coffee arrives at your seat — zero interruption.",
    cta: "See the menu",
    bg: "#FFF8F5",
    icon: Coffee,
    iconColor: "#9a3412",
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <p className="font-body text-sm text-[#767872] max-w-xs leading-relaxed sm:text-right">
              From air to fiber to coffee at your desk — every detail is engineered for your focus.
            </p>
          </div>
        </div>
