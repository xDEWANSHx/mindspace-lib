...
export default function HeroSection() {
  ...
  const heroImg = settings.heroImage || DEFAULT_SYSTEM_SETTINGS.heroImage;
  const isExternalHero = heroImg && (heroImg.startsWith("http") || heroImg.startsWith("data:"));
    ...
    <section id="hero-section" className="relative w-full min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 md:px-16 w-full pt-32 pb-20">
        <div className="max-w-3xl space-y-7 text-left">
          ...
          >
            Ambikapur&apos;s first premium study sanctuary — silent cabins, {settings.internetSpeed || "100+ Mbps"}, artisanal coffee, and an environment calibrated for your deepest focus.
          </p>
          ...
          >
            <div className="flex items-center gap-2">
              <span className="text-[#00A8CC] font-headline-md text-xl font-black">
            ...
            <div>
              <span className="font-headline-md text-xl font-black text-[#1C2421]">
            ...
            <div>
              <span className="font-headline-md text-xl font-black text-[#1C2421]">
                {settings.dailyAccessHours || "15 hrs"}
              </span>
