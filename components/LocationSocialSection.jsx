          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            ...
            <div className="bg-[#262F2C] rounded-[32px] p-6 sm:p-8 wood-stroke space-y-6">
              ...
              <div className="space-y-3 pt-2">
                ...
                >
                  <div>
                    <p className="font-label-caps text-xs text-white/50 uppercase font-bold">Desk &amp; Admission</p>
                ...
                <a
                  href="tel:+918076592231"
                  className="flex items-center justify-between p-4 rounded-2xl bg-[#1C2421] border border-white/10 hover:border-[#D4B28C] transition-all group cursor-pointer"
                >
                  <div>
                    <p className="font-label-caps text-xs text-white/50 uppercase font-bold">Helpline &amp; Support</p>
                    <p className="font-headline-md text-base text-white group-hover:text-[#D4B28C] transition-colors">
                      +91 80765 92231
                    </p>
                  </div>
                  <ExternalLink className="w-4 h-4 text-white/40 group-hover:text-[#D4B28C] transition-colors" />
                </a>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/50">@mindspace_abkp</p>
                  </div>
                </a>

                {/* WhatsApp */}
                <a
                  href="https://wa.me/919899120489"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/50">Chat Directly</p>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 p-3.5 rounded-2xl bg-[#1C2421] border border-white/10 hover:border-[#FF0000] hover:bg-[#FF0000]/10 transition-all cursor-pointer group"
                >
                  ...
                  <div>
                    <p className="font-headline-md text-xs text-white">YouTube</p>
                    <p className="text-[10px] text-white/50">MindSpace Channel</p>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 p-3.5 rounded-2xl bg-[#1C2421] border border-white/10 hover:border-[#0A66C2] hover:bg-[#0A66C2]/10 transition-all cursor-pointer group"
                >
                  ...
                  <div>
                    <p className="font-headline-md text-xs text-white">LinkedIn</p>
                    <p className="text-[10px] text-white/50">Official Page</p>
                  </div>
                </a>
              </div>
            </div>
