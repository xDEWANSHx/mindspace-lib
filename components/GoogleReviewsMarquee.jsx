...
export default function GoogleReviewsMarquee() {
  ...
  const REVIEWS = [
    ...
    },
    {
      ...
      text: "MindSpace provided me the exact 15-hour daily discipline I needed during my exam revision. 1 Gbps fiber wifi, AC, and peaceful study atmosphere made it seamless!"
    }
  ];
