...
const FAQ_ITEMS = [
  ...
  {
    q: "How does Noiric Café desk ordering work?",
    a: "Every cabin has an integrated QR code. Scan it to open the Noiric Café express menu — artisanal coffee or snacks are delivered directly to your desk, zero interruption.",
  },
  {
